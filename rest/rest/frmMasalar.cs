...
namespace rest
{
    public partial class frmMasalar : Form
    {
        ...
        private void btnMasa2_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa2.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa2.Name;
        ...
        private void btnMasa3_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa3.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa3.Name;
        ...
        private void btnMasa4_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa4.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa4.Name;
        ...
        private void btnMasa5_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa5.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa5.Name;
        ...
        private void btnMasa6_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa6.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa6.Name;
        ...
        private void btnMasa7_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa7.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa7.Name;
        ...
        private void btnMasa8_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa8.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa8.Name;
        ...
        private void btnMasa9_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa9.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa9.Name;
        ...
        private void btnMasa10_Click(object sender, EventArgs e)
        {
            ...
            cGeneral._ButtonValue = btnMasa10.Text.Substring(uzunluk - 6, 6);
            cGeneral._ButtonName = btnMasa10.Name;
                    ...
                    if (item is Button)
                    {
                        ...
                        else if (item.Name == "btnMasa" + dr["ID"].ToString() && dr["DURUM"].ToString() == "2")
                        {
                            ...
                            item.Text = String.Format("{0}{1}{2}",
                                fark.Days > 0 ? string.Format("{0} Gun", fark.Days) : "",
